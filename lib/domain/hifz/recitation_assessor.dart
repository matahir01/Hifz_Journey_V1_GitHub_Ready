...
abstract class RecitationAssessor {
  Future<RecitationAssessment> assess({
    required int ayahId,
...
class DisabledRecitationAssessor implements RecitationAssessor {
  @override
  Future<RecitationAssessment> assess({
    required int ayahId,
    required String expectedText,
    ...
    return const RecitationAssessment(
      recallScore: 0,
      issues: ['AI recitation assessment is not configured yet.'],
    );
  }
}

                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Slider(
                        ...
                        max: 10,
                        divisions: 9,
                        onChanged: (v) => controller.setDailyTarget(v.round()),
                      ),
                    ],
                  ),
                ),
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Stream verse-by-verse or download Surahs for offline playback.',
                  ),
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  subtitle: const Text(
                    'Save Hifz progress, history, settings and bookmarks. Downloaded MP3 files are not included.',
                  ),
                  onTap: () async {
                    try {
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Replace current local progress with a saved Hifz Journey backup.',
                  ),
                  onTap: () async {
